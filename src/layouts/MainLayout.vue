      ...
      >
        <q-scroll-area
          ...
          <q-list padding>
            ...
            <q-item to="/Familia" exact clickable v-ripple>
              <q-item-section avatar>
                <q-icon name="list"/>
              </q-item-section>
            ...
            <q-item to="/convidados" exact clickable v-ripple>
              <q-item-section avatar>
                <q-icon name="list"/>
              </q-item-section>
            ...
            <q-item to="/ajuda" exact clickable v-ripple>
              <q-item-section avatar>
                <q-icon name="help"/>
              </q-item-section>
